...
class CreateAwsLambdaCustomRuntimeDefaultKotlinMavenJunitSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdacustomruntime-createawslambdacustomruntimedefaultkotlinmavenjunitspec"
    }
