...
class CreateGrpcGroovyGradleSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-grpc-creategrpcgroovygradlespec"
    }
    ...
    void '#applicationType with #lang and #buildTool'(ApplicationType applicationType, Language lang, BuildTool buildTool) {
        ...
        ApplicationType.GRPC | Language.GROOVY         | BuildTool.GRADLE
    }
}
