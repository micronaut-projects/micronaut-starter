...
class CreateAwsLambdaGraalvmDefaultKotlinMavenJunitSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmdefaultkotlinmavenjunitspec"
    }
