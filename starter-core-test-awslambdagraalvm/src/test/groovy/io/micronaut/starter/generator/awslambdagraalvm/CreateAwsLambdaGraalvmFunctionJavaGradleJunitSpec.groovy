...
class CreateAwsLambdaGraalvmFunctionJavaGradleJunitSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmfunctionjavagradlejunitspec"
    }
