...
class CreateAwsLambdaGraalvmFunctionKotlinGradleJunitSpec extends CommandSpec {

    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmfunctionkotlingradlejunitspec"
    }
