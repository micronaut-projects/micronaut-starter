...
class CreateAwsLambdaGraalvmFunctionKotlinMavenJunitSpec extends CommandSpec {

    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmfunctionkotlinmavenjunitspec"
    }
