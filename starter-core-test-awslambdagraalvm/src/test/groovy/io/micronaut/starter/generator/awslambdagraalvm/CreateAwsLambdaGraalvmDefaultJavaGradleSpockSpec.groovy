...
class CreateAwsLambdaGraalvmDefaultJavaGradleSpockSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmdefaultjavagradlespockspec"
    }
