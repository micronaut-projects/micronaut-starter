...
class CreateAwsLambdaGraalvmFunctionJavaMavenSpockSpec extends CommandSpec {

    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmfunctionjavamavenspockspec"
    }
