...
class CreateAwsLambdaGraalvmDefaultJavaGradleJunitSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmdefaultjavagradlejunitspec"
    }
