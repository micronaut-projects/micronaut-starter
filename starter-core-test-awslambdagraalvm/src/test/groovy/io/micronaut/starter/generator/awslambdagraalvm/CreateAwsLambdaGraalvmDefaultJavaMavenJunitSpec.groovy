...
class CreateAwsLambdaGraalvmDefaultJavaMavenJunitSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmdefaultjavamavenjunitspec"
    }
