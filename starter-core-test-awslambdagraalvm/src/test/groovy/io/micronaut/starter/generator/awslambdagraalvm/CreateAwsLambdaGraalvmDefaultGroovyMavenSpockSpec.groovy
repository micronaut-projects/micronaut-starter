...
class CreateAwsLambdaGraalvmDefaultGroovyMavenSpockSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambdagraalvm-createawslambdagraalvmdefaultgroovymavenspockspec"
    }
