...
class CreateCliGroovyMavenSpockSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-createcli-createcligroovymavenspockspec"
    }
    ...
    void 'create-#applicationType with #lang and #buildTool and test framework: #testFramework'(ApplicationType applicationType,
        ...
        ApplicationType.CLI | Language.GROOVY         | BuildTool.MAVEN   | TestFramework.SPOCK
    }
}
