...
class CreateCliKotlinGradleJunitSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-createcli-createclikotlingradlejunitspec"
    }
    ...
    void 'create-#applicationType with #lang and #buildTool and test framework: #testFramework'(ApplicationType applicationType,
        ...
        ApplicationType.CLI | Language.KOTLIN         | BuildTool.GRADLE  | TestFramework.JUNIT
    }
}
