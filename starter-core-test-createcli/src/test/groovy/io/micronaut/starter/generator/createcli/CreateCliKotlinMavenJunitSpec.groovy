...
class CreateCliKotlinMavenJunitSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-createcli-createclikotlinmavenjunitspec"
    }
    ...
    void 'create-#applicationType with #lang and #buildTool and test framework: #testFramework'(ApplicationType applicationType,
        ...
        ApplicationType.CLI | Language.KOTLIN         | BuildTool.MAVEN   | TestFramework.JUNIT
    }
}
