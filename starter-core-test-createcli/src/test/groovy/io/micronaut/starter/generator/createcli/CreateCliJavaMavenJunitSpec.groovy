...
class CreateCliJavaMavenJunitSpec extends CommandSpec {

    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-createcli-createclijavamavenjunitspec"
    }
    ...
    void 'create-#applicationType with #lang and #buildTool and test framework: #testFramework'(ApplicationType applicationType,
        ...
        ApplicationType.CLI | Language.JAVA           | BuildTool.MAVEN   | TestFramework.JUNIT
    }
}
