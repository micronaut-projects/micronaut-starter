...
class CreateJobSpec extends CommandSpec implements CommandFixture {
    ...
    @Unroll
    void "test creating a job - #language.getName()"() {
        ...
        where:
        language        | file
        Language.JAVA   | "src/main/java/example/micronaut/Ticker.java"
        Language.KOTLIN | "src/main/kotlin/example/micronaut/Ticker.kt"
        Language.GROOVY | "src/main/groovy/example/micronaut/Ticker.groovy"
    }
