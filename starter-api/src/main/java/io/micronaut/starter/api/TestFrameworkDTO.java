 ...
 * See the License for the specific testFramework governing permissions and
...
@Introspected
public class TestFrameworkDTO extends Linkable implements Named, Described, Selectable<String> {
    ...
    @Creator
    @Internal
    TestFrameworkDTO(String name, String description, String value, LanguageDTO defaultLanguage, List<LanguageDTO>supportedLanguages) {
        this.name = name;
