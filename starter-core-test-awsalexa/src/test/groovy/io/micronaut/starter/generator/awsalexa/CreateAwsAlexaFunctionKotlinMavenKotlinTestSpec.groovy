...
class CreateAwsAlexaFunctionKotlinMavenKotlinTestSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        return "starter-core-test-awsalexa-createawsalexafunctionkotlinmavenkotlintestspec"
    }
