...
class CreateAwsAlexaDefaultKotlinGradleKotlinTestSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        return "starter-core-test-awsalexa-createawsalexadefaultkotlingradlekotlintestspec"
    }
