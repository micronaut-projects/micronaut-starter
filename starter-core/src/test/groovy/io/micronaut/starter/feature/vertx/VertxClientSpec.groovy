...
class VertxClientSpec extends Specification implements ProjectFixture, ContextFixture {
...
""")
    ...
    void 'test vertx-mysql-client configuration'() {
        when:
        GeneratorContext commandContext = buildCommandContext(['vertx-mysql-client'])
