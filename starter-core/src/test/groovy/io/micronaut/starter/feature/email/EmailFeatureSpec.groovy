...
class EmailFeatureSpec extends ApplicationContextSpec {
    ...
    void "verify email features add dependencies"(BuildTool buildTool,
        ...
        BuildTool.GRADLE        | 'io.micronaut.email' | 'micronaut-email-ses'      | ['email-ses']
        ...
        BuildTool.GRADLE_KOTLIN | 'io.micronaut.email' | 'micronaut-email-ses'      | ['email-ses']
        ...
        BuildTool.MAVEN         | 'io.micronaut.email' | 'micronaut-email-ses'      | ['email-ses']
        ...
        BuildTool.GRADLE        | 'io.micronaut.email' | 'micronaut-email-ses'      | ['email-ses', 'views-thymeleaf']
        ...
        BuildTool.GRADLE_KOTLIN | 'io.micronaut.email' | 'micronaut-email-ses'      | ['email-ses', 'views-thymeleaf']
        ...
        BuildTool.MAVEN         | 'io.micronaut.email' | 'micronaut-email-ses'      | ['email-ses', 'views-thymeleaf']
