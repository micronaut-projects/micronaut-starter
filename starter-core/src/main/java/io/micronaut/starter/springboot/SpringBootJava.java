...
public class SpringBootJava implements LanguageFeature {
    ...
    protected void addApplication(GeneratorContext generatorContext) {
        String testSourcePath = generatorContext.getSourcePath("/{packagePath}/{className}");
        generatorContext.addTemplate("Application",
                new RockerTemplate(testSourcePath, springBootJavaApplication.template(generatorContext.getProject())));
    }
