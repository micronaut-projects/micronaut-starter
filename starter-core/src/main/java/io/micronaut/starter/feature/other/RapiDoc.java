...
import io.micronaut.starter.feature.other.template.openApiRapiDocProperties;
...
public class RapiDoc implements Feature, MicronautServerDependent {
    ...
    public void apply(GeneratorContext generatorContext) {
        generatorContext.addTemplate("openapiRapiDocProperties", new RockerTemplate("openapi.properties", openApiRapiDocProperties.template()));
