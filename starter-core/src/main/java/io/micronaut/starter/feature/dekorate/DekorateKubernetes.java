...
public class DekorateKubernetes extends AbstractDekoratePlatformFeature {
    ...
    public void apply(GeneratorContext generatorContext) {
        generatorContext.addAnnotationProcessor("io.dekorate", "kubernetes-annotations", "${dekorate.version}");
        generatorContext.addDependency("io.dekorate", "kubernetes-annotations");
    }
}
