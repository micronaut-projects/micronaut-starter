 ...
 * @since 2.3
 */
@Requires(property = "micronaut.starter.feature.github.workflow.azure.container.instance.graalvm.enabled", value = StringUtils.TRUE, defaultValue = StringUtils.TRUE)
@Singleton
