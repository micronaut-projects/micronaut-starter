...
public class JsonSchemaGeneratorFeature implements Feature {
    ...
    private static final Dependency JSON_SCHEMA_GENERATOR_DEPENDENCY = MicronautDependencyUtils.jsonSchemaDependency()
            .artifactId("micronaut-json-schema-generator")
            .compile()
            .build();
    ...
    public String getDescription() {
        return "Adds Source Generator from JSON Schema to a Micronaut Application";
    }
    ...
    public void apply(GeneratorContext generatorContext) {
        generatorContext.addDependency(JSON_SCHEMA_GENERATOR_DEPENDENCY);
