 ...
 * @author Tim Yates
 */
public abstract class ChatBotsGcpFunction extends ChatBots implements CloudFeature, AzureMicronautRuntimeFeature {

    protected final GoogleCloudRawFunction rawFunction;

    protected ChatBotsGcpFunction(MicronautValidationFeature validationFeature, GoogleCloudRawFunction rawFunction) {
