...
public class Gradle implements BuildFeature {
    ...
    private static final String GRADLE_9_6_0 = "9.6.0";
    ...
    private static final Map<String, String> GRADLEW_MAP = Map.of(
            GRADLE_9_6_0, GRADLE + SLASH  + GRADLE + DASH + GRADLE_9_6_0 + SLASH + GRADLEW
    );
    private static final Map<String, String> GRADLEW_BAT_MAP = Map.of(
            GRADLE_9_6_0, GRADLE + SLASH  + GRADLE + DASH + GRADLE_9_6_0 + SLASH + GRADLEW_BAT);

    private static final Map<String, String> WRAPPER_JAR_MAP = Map.of(
            GRADLE_9_6_0, GRADLE + SLASH  + GRADLE + DASH + GRADLE_9_6_0 + SLASH + WRAPPER_JAR
    );
    private static final Map<String, String> WRAPPER_PROPS_MAP = Map.of(
            GRADLE_9_6_0, GRADLE + SLASH  + GRADLE + DASH + GRADLE_9_6_0 + SLASH + WRAPPER_PROPS);
    ...
    public void apply(GeneratorContext generatorContext) {
        ...
        if (generatorContext.isMicronautFramework()) {
            ...
            // the Gitignore default feature only targets the Micronaut framework
    ...
    protected void addGradleInitFiles(GeneratorContext generatorContext) {
        ...
        String gradleVersion = GRADLE_9_6_0;
    ...
    /**
     * Adds a .gitignore file for projects not using the Micronaut framework.
     * @param generatorContext Generator Context
     * @deprecated For the Micronaut framework the .gitignore file is generated by {@link io.micronaut.starter.feature.Gitignore}. Override {@link io.micronaut.starter.feature.Gitignore#gitIgnore(GeneratorContext)} instead.
     */
     ...
     * @deprecated Override {@link io.micronaut.starter.feature.Gitignore#gitIgnore(GeneratorContext)} instead.
     */
    @Deprecated(forRemoval = true, since = "5.1.6")
