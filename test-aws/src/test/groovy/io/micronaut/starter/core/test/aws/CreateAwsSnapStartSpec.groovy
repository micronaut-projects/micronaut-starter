...
class CreateAwsSnapStartSpec extends CommandSpec {
    ...
    @Unroll
    void 'create-#applicationType with graalvm and amazon-api-gateway-http does not enable SnapStart #lang and #build and test framework: #testFramework'(ApplicationType applicationType,
                                                                                                                                                          Language lang,
                                                                                                                                                          BuildTool build,
                                                                                                                                                          TestFramework testFramework) {
        given:
        List<String> features = [AwsLambda.FEATURE_NAME_AWS_LAMBDA, Cdk.NAME, AmazonApiGatewayHttp.NAME, GraalVM.FEATURE_NAME_GRAALVM]
        generateProject(lang, build, features, applicationType, testFramework)
