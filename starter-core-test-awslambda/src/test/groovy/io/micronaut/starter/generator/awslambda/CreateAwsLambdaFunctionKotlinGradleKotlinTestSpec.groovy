...
class CreateAwsLambdaFunctionKotlinGradleKotlinTestSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambda-createawslambdafunctionkotlingradlekotlintestspec"
    }
