...
class CreateAwsLambdaFunctionKotlinMavenKotlinTestSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-awslambda-createawslambdafunctionkotlinmavenkotlintestspec"
    }
