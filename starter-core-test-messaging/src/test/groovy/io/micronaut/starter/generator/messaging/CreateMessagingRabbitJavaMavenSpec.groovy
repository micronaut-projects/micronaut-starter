...
class CreateMessagingRabbitJavaMavenSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-messaging-createmessagingrabbitjavamavenspec"
    }
    ...
    void 'test basic create-messaging-app for #feature and #lang and #buildTool'(ApplicationType applicationType,
        ...
        ApplicationType.MESSAGING | RabbitMQ.NAME | Language.JAVA | BuildTool.MAVEN
    }
}
