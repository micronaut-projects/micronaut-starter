...
class CreateMessagingRabbitGroovyGradleSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-messaging-createmessagingrabbitgroovygradlespec"
    }
    ...
    void 'test basic create-messaging-app for #feature and #lang and #buildTool'(ApplicationType applicationType,
        ...
        ApplicationType.MESSAGING | RabbitMQ.NAME | Language.GROOVY | BuildTool.GRADLE
    }
}
