...
class CreateMessagingKafkaGroovyMavenSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-messaging-createmessagingkafkagroovymavenspec"
    }
    ...
    void 'test basic create-messaging-app for #feature and #lang and #buildTool'(ApplicationType applicationType,
        ...
        ApplicationType.MESSAGING | Kafka.NAME | Language.GROOVY | BuildTool.MAVEN
    }
}
