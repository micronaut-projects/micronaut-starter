...
class CreateMessagingKafkaJavaGradleSpec extends CommandSpec {
    @Override
    String getTempDirectoryPrefix() {
        "starter-core-test-messaging-createmessagingkafkajavagradlespec"
    }
    ...
    void 'test basic create-messaging-app for #feature and #lang and #buildTool'(ApplicationType applicationType,
        ...
        ApplicationType.MESSAGING | Kafka.NAME | Language.JAVA | BuildTool.GRADLE
    }
}
